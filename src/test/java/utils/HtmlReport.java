...
public class HtmlReport {
    ...
    public HtmlReport(String suiteName) {
        ...
        try {
            File json = new File(Constants.RUTA_CONFIG_HTML_REPORT+ "src\\test\\java\\utils\\htmlConfig.json");
            System.out.println("Ruta final: " + Constants.RUTA_CONFIG_HTML_REPORT + "src\\test\\java\\utils\\htmlConfig.json");
